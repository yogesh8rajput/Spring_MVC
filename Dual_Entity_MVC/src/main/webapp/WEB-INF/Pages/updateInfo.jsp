...
<head>
<meta charset="UTF-8">
<title>Docter Information Form</title>
    <style>
        body {
...
%>
        ...
        <form action="updateinfo">
            ...
            <div class="form-group">
                ...
                <input type="text" id="rollno" name="d_id" placeholder="Enter your ID" required value="<%=std.getD_id()%>">
            </div>
            <div class="form-group">
                <label for="percentage">Percentage:</label>
                <input type="text" id="percentage" name="d_as" placeholder="Enter your Salary" required value="<%=std.getD_as()%>">
            </div>
